...
const GoIcon = ({fill,position}:GoIconProps) => {
  return (
    <svg id="emoji" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" style={
      position === 'top' ?
        {
          rotate: '-90deg'
        }
